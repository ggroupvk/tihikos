...
export const TIMELINE_ENRICHMENT: Record<number, TimelineEnrichment> = {
  1: {
    ...
    body_ru:
      '23 февраля 2023 года Священный Синод Кипрской Церкви избирает архимандрита Тихика Вриониса 70-м митрополитом Пафосским. Избрание завершает почти двухмесячную каноническую процедуру после освобождения кафедры. Голосование проходит при широком согласии иерархов.',
    body_en:
  ...
  3: {
    ...
    body_ru:
      'Первая публичная конфронтация с Архиепископом Георгием III. Митрополит Тихик отказывается от сослужения из-за позиции Архиепископа по общению с ПЦУ. Разногласие становится открытым.',
    body_en:
  ...
  4: {
    ...
    body_ru:
      'Группа иерархов формулирует ряд обвинений против митрополита Тихика: рукоположение непоминающего клирика, отказ в венчании, публичная критика католицизма и обязательного полового воспитания. Обвинения готовят синодальное рассмотрение.',
    body_en:
  ...
  5: {
    ...
    body_ru:
      '22 мая 2025 года Священный Синод Кипрской Церкви голосованием 10 «за» при 6 «против» постановил низложить митрополита Тихика с управления Пафосской митрополией. Архиерейский сан сохранён. Решение вызывает международную реакцию.',
    body_en:
  ...
  6: {
    ...
    body_ru:
      'Митрополит Тихик издаёт официальный ответ: «Уважаю решение Священного Синода» — но заявляет, что остаётся на своей канонически утверждённой кафедре и готовит апелляцию во Вселенский Патриархат. Декларирует верность Церкви и Отцам.',
    body_en:
  ...
  9: {
    ...
    body_ru:
      'Дело остаётся открытым в сознании верующих. Митрополит Тихик в настоящее время пребывает на Святой Горе Афон. Общественные инициативы за справедливое каноническое пересмотрение продолжаются.',
    body_en:
