  ...
  ru: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: '22 мая 2025 года Синод постановил низложить митрополита. В настоящее время Тихикос пребывает на Святой Горе Афон, оставаясь в своей канонически утверждённой кафедре.',
      },
    ],
    placeholder:
