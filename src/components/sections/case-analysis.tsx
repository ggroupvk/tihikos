    ...
    sections: [
      {
        ...
        body: 'Синодальное решение 22 мая 2025 года было принято голосованием 10 «за» при 6 «против». Митрополит Тихикос и его команда юристов утверждают, что отдельные обвинения не рассматривались в отдельных производствах, а состав следственной комиссии не соответствует священным канонам.',
      },
      {
