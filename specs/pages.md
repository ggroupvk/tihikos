...
1. **Hero-блок** — фото митрополита Тихикоса в облачении, актуальная цитата, 2 кнопки: «Узнать дело» → /case, «Смотреть видео» → /videos
...
- Плейлисты: «Дело Тихикоса» (8), «Поддержка от клириков» (16), «Проповеди» (17)
